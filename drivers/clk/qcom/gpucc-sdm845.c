...
static const struct freq_tbl  ftbl_gpu_cc_gx_gfx3d_clk_src_sdm845_v2[] = {
	F(175000000, P_CRC_DIV,  1, 0, 0),
	F(269000000, P_CRC_DIV,  1, 0, 0),
	F(363000000, P_CRC_DIV,  1, 0, 0),
	F(457000000, P_CRC_DIV,  1, 0, 0),
	F(551000000, P_CRC_DIV,  1, 0, 0),
	F(645000000, P_CRC_DIV,  1, 0, 0),
	F(739000000, P_CRC_DIV,  1, 0, 0),
...
static void gpu_cc_gfx_sdm845_fixup_sdm845v2(void)
{
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_MIN] = 175000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOWER] =
		269000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOW] = 363000000;
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_NOMINAL_L1] =
		645000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH] = 739000000;
